 ...
 * @Funtion 家庭安防/安防录像
 */
public class AlarmVideoActivity extends BaseFragmentActivity implements OnClickListener {
	...
	private class AlarmVideoAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (mCheckPos == position) {
				holder.textAlarmVideo.setTextColor(getResources().getColor(R.color.Teal));
			} else {
				holder.textAlarmVideo.setTextColor(getResources().getColor(R.color.DarkBlue));
			}
			return convertView;
		}
