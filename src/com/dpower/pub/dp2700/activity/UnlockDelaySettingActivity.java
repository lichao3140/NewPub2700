 ...
 * 开锁设置
 */
public class UnlockDelaySettingActivity extends BaseActivity implements OnClickListener {
	...
	private void checkInput() {
		...
		MyLog.print(TAG, "extensionNum = " + extensionNum + ",unlockDelay = " + unlockDelay);
		result = DPFunction.toDoorSetLockParam(extensionNum, unlockDelay, -1, -1);
		MyLog.print(TAG, "result = " + result);
		if (result == 0) {
