...
import com.dpower.pub.dp2700.wheelview.ArrayWheelAdapter;
import com.dpower.pub.dp2700.wheelview.NumericWheelAdapter;
import com.dpower.pub.dp2700.wheelview.OnWheelChangedListener;
import com.dpower.pub.dp2700.wheelview.WheelView;
...
public class AlarmAreaDialog extends BaseActivity implements OnClickListener {
	...
	private void init() {
		...
		List<AlarmTypeInfo> typeList = DPFunction.getAlarmTypeNameList();
		String[] types = new String[typeList.size()];
		for (int i = 0; i < typeList.size(); i++) {
			types[i] = typeList.get(i).name;
		}
