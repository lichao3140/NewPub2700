 ...
 * 语言设置窗口
 */
public class LanguageSettingDialog extends BaseActivity implements OnClickListener {
	private static final String TAG = "LanguageSettingDialog";
	...
	public void onClick(View v) {
		...
		case R.id.btn_english:
			...
			break;
		case R.id.btn_save:
			// Language.updateLanguage(LanguageSettingDialog.this,mFlag);
			Language.updateLanguage(mFlag);
			finish();
			break;
