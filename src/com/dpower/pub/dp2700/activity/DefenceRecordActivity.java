 ...
 * @Funtion 家庭安防/安防日志
 */
public class DefenceRecordActivity extends BaseFragmentActivity implements OnClickListener {
		...
		case R.id.btn_delete:
			if (mAdapter.checkId >= 0) {
				...
				dialog.setOnClickListener(new OnDialogClickListener() {
					...
					@Override
					public void onClick() {
						DPFunction.deleteSafeModeLog(mSafeModeInfos.get(mAdapter.checkId).getDb_id());
