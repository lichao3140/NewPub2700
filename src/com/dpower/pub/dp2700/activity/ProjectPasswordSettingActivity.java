 ...
 * 修改工程密码
 */
public class ProjectPasswordSettingActivity extends BaseActivity implements OnClickListener {
	...
	private boolean checkInput() {
		if (mEditPasswordOld.getText().toString().equals("") || mEditPassword.getText().toString().equals("")
				|| mEditPasswordAgain.getText().toString().equals("")) {
			MyToast.show(R.string.new_password_cannot_null);
			return false;
		}
		if (mEditPasswordOld.getText().toString().length() != 6 || mEditPassword.getText().toString().length() != 6
