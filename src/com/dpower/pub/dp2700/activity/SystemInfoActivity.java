...
public class SystemInfoActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String roomName = getString(R.string.system_info_room) + areaStr + getString(R.string.text_area) + mewsStr
				+ getString(R.string.text_building) + unitStr + getString(R.string.text_unit) + roomStr
				+ getString(R.string.text_room) + extensionStr + getString(R.string.text_extension);
		...
		mTextIp.setText(getString(R.string.system_info_ip_address) + info.getIp() + ", " + info.getMask() + ", "
				+ info.getGw());
		mTextNetCfgVer.setText(getString(R.string.system_info_net_cfg) + DPFunction.getNetCfgVer());

		try {
			PackageInfo apkInfo = getPackageManager().getPackageInfo(getPackageName(), 0);
			mTextAPKVersion.setText(getString(R.string.system_info_version) + apkInfo.versionCode);
		} catch (NameNotFoundException e) {
			mTextAPKVersion.setText(getString(R.string.system_info_version) + "test");
			e.printStackTrace();
		}
		mTextDeviceType.setText(getString(R.string.system_info_type) + getVersionName());
		mTextSystemType.setText(getString(R.string.system_info) + "Android " + Build.VERSION.RELEASE);
