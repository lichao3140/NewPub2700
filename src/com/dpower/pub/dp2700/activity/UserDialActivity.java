...
public class UserDialActivity extends BaseActivity implements OnClickListener {
	...
	private void createData() {
		ArrayList<CallInfo> callInfos = DPFunction
				.getCallLogList(CallInfo.CALL_OUT_ACCEPT | CallInfo.CALL_OUT_UNACCEPT);
		if (callInfos != null) {
			...
			mAdapter = new ArrayAdapter<String>(this, R.layout.adapter_call_record_list, datas);
