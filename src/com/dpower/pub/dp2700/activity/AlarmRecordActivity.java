 ...
 * @Funtion 家庭安防/报警记录
 */
public class AlarmRecordActivity extends BaseFragmentActivity implements OnClickListener {
	...
	private class AlarmRecordAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			ViewHolder holder;
			if (convertView == null) {
				convertView = LayoutInflater.from(mContext).inflate(R.layout.adapter_alarm_record_list, null);
		...
		class ViewHolder {
			...
			public void setCheck(boolean isChecked) {
				if (isChecked) {
					...
					id.setText("√ " + code);
					id.setTextColor(mContext.getResources().getColor(R.color.DarkIndigo));
					num.setTextColor(mContext.getResources().getColor(R.color.DarkIndigo));
					name.setTextColor(mContext.getResources().getColor(R.color.DarkIndigo));
					type.setTextColor(mContext.getResources().getColor(R.color.DarkIndigo));
					time.setTextColor(mContext.getResources().getColor(R.color.DarkIndigo));
				} else {
					id.setTextColor(mContext.getResources().getColor(R.color.DarkDeepGrey));
					num.setTextColor(mContext.getResources().getColor(R.color.DarkDeepGrey));
					name.setTextColor(mContext.getResources().getColor(R.color.DarkDeepGrey));
					type.setTextColor(mContext.getResources().getColor(R.color.DarkDeepGrey));
					time.setTextColor(mContext.getResources().getColor(R.color.DarkDeepGrey));
				}
			}
		}
	};
