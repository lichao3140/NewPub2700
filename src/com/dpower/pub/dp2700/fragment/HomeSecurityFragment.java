...
import com.dpower.pub.dp2700.activity.ModeSettingActivity;
...
public class HomeSecurityFragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		if (ProjectConfigure.project == 1) {
			mRootView = inflater.inflate(R.layout.fragment_home_security1, container, false);
		} else if (ProjectConfigure.project == 2) {
			mRootView = inflater.inflate(R.layout.fragment_home_security2, container, false);
		} else {
			mRootView = inflater.inflate(R.layout.fragment_home_security, container, false);
		}
		init();
		return mRootView;
	}
	...
	public void onClick(View v) {
		...
		case R.id.btn_out_security:
			if (ConstConf.UNSAFE_MODE != DPFunction.getSafeMode() || DPFunction.getAlarming()) {
	...
	private void startActivity(int mode) {
		...
		intent.putExtra(ConstConf.SAFE_MODE, mode);
