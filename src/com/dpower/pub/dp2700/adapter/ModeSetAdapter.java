...
public class ModeSetAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(R.layout.adapter_mode_set_list, parent, false);
		...
		holder.buttonSwitch.setText(getSafeModeEnable(position) ? mContext.getString(R.string.text_open)
