...
public class SMSAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(R.layout.adapter_sms_list, null);
	...
	public class ViewHolder {
		...
		public void setCheck(boolean isChecked) {
			if (isChecked) {
				...
				number.setTextColor(mContext.getResources().getColor(R.color.DarkIndigo));
				topic.setTextColor(mContext.getResources().getColor(R.color.DarkIndigo));
				date.setTextColor(mContext.getResources().getColor(R.color.DarkIndigo));
				isRead.setTextColor(mContext.getResources().getColor(R.color.DarkIndigo));
			} else {
				number.setTextColor(mContext.getResources().getColor(R.color.Black));
				topic.setTextColor(mContext.getResources().getColor(R.color.Black));
				date.setTextColor(mContext.getResources().getColor(R.color.Black));
				isRead.setTextColor(mContext.getResources().getColor(R.color.Black));
			}
		}
	}
}
